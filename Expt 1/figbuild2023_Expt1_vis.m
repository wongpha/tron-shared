% Figure builder
clearvars();
cd('C:\Users\alvinw\iCloudDrive\Analysis\TronAnalysis\Expt1 [2021]\PSubj2\out\vis_newscript');
...
for l = 1:numel(lengths)
    for i = 1
        ...
        ax.FontSize = 12; 
        ylabel('% signal change','fontsize', 15);
        title(sprintf('%s', [num2str(intensities(i)), '% contrast']),'fontsize',16);
    end
end
...
bstats = csvread("C:\Users\alvinw\iCloudDrive\Analysis\TronAnalysis\Expt1 [2021]\PSubj2\boot_out\visual\BootStp_Amplitude_durationManipulation.csv",0,0);
...
title(sprintf('%s', [num2str(1), '% contrast']),'fontsize',16);
...
title(sprintf('%s', [num2str(10), '% contrast']),'fontsize',16);
...
ax = gca;
ax.FontSize = 13; 
title(sprintf('%s', [num2str(100), '% contrast']),'fontsize',16);

hold off

%% TIME TO PEAK
nbstats = csvread('TimeToPeak_durationManipulation.csv',0,0);
bstats = csvread("C:\Users\alvinw\iCloudDrive\Analysis\TronAnalysis\Expt1 [2021]\PSubj2\boot_out\visual\BootStp_TimeToPeak_durationManipulation.csv",0,0);
...
bstats = csvread("C:\Users\alvinw\iCloudDrive\Analysis\TronAnalysis\Expt1 [2021]\PSubj2\boot_out\visual\BootStp_PeakOnset_durationManipulation.csv",0,0);
...
bstats = csvread("C:\Users\alvinw\iCloudDrive\Analysis\TronAnalysis\Expt1 [2021]\PSubj2\boot_out\visual\MaxIntensity_BootStp_Amplitude_durationManipulation.csv",0,0);
xaxes = [100 300 900];
for i = 1:numel(xaxes)
...
bstats = csvread("C:\Users\alvinw\iCloudDrive\Analysis\TronAnalysis\Expt1 [2021]\PSubj2\boot_out\visual\MaxIntensity_BootStp_TimeToPeak_durationManipulation.csv",0,0);
xaxes = [100 300 900];
...
subplot(2,3,5)
bstats = csvread("C:\Users\alvinw\iCloudDrive\Analysis\TronAnalysis\Expt1 [2021]\PSubj2\boot_out\visual\MaxDuration_BootStp_Amplitude_intensityManipulation.csv",0,0);
...
subplot(2,3,6)
bstats = csvread("C:\Users\alvinw\iCloudDrive\Analysis\TronAnalysis\Expt1 [2021]\PSubj2\boot_out\visual\MaxDuration_BootStp_TimeToPeak_intensityManipulation.csv",0,0);
